...
<main>
	<div class="page-content container note-has-grid">
		...
		<?= view('components/folders/folder-bar', compact('folders', 'activeFolder')) ?>
		<?= view('components/notes/list', compact('notes')) ?>
		<!-- Modal Add notes -->
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="note-description">
												...
												<textarea id="note-has-description"
														  class="form-control"
														  minlength="60"
